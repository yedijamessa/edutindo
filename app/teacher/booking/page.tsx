            ...
            <div className="flex">
                <aside className="hidden lg:block w-64 border-r bg-card p-6 min-h-screen sticky top-0">
                    ...
                    <nav className="space-y-1">
                        <a href="/teacher" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:bg-accent">
                            <School className="w-5 h-5" />
                            Dashboard
                        </a>
                        <a href="/teacher/booking" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium bg-primary text-primary-foreground">
                    ...
                    <div className="max-w-7xl mx-auto space-y-8">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-2">Reserve classrooms and facilities for teaching</p>
                            </div>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input placeholder="e.g., Math Class, Meeting..." />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Expected Attendees</label>
                                            <Input type="number" min="1" placeholder="Number of students/attendees" />
                                        </div>
                                    </div>
